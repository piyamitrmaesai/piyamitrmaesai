...
## แก้ไขข้อความทุกหน้าจาก CMS
เวอร์ชันนี้เพิ่มเมนู **เนื้อหาหน้าเว็บไซต์** ใน `/admin/` สำหรับแก้ไขข้อความของ:
- หน้าแรก
- เกี่ยวกับเรา
- ภารกิจ
- ข่าวสาร (หัวข้อ/ข้อความประกอบหน้า; ตัวข่าวอยู่เมนู ข่าวสาร)
- อาสาสมัคร
- ร่วมบริจาค
- ดาวน์โหลด
- ติดต่อเรา

เมื่อแก้ไขแล้วกด **Publish** ระบบจะ Commit ข้อมูลไป GitHub และ Netlify จะ Build/Deploy ใหม่อัตโนมัติ เมื่อสถานะ Deploy เป็น Published ให้รีเฟรชหน้าเว็บ (Ctrl+F5 หากจำเป็น)

ข้อมูลโทรศัพท์ อีเมล LINE ที่อยู่ Facebook แผนที่ และบัญชีบริจาค อยู่ในเมนู **ตั้งค่าเว็บไซต์**


## เมนูเว็บไซต์เวอร์ชันนี้
หน้าแรก | เกี่ยวกับเรา | ภารกิจ | ข่าวสาร | อาสาสมัคร | ร่วมบริจาค | ดาวน์โหลด | ติดต่อเรา

หมายเหตุ: เวอร์ชันนี้ลบหน้าและเมนู “ศูนย์สื่อสาร” ออกจากเว็บไซต์และ CMS แล้ว

## ดีไซน์ตามภาพตัวอย่างล่าสุด
เวอร์ชันนี้ปรับหน้าเว็บเป็น Header น้ำเงินเข้ม + Hero + แถบข้อมูลสีเหลือง + ภารกิจ/ข่าวล่าสุด + CTA + Footer ตามภาพตัวอย่างที่อนุมัติ และยังคง CMS เดิมไว้ครบ อ่าน `UPDATE_REFERENCE_DESIGN_TH.txt` สำหรับวิธีอัปเดต

> `assets/hero-rescue-demo.webp` เป็นภาพประกอบสำหรับเดโมดีไซน์ ควรเปลี่ยนเป็นภาพปฏิบัติงานจริงของสมาคมจากหน้า Admin ก่อนใช้งานทางการ
